...
export const STRAPI_URL = "http://3.13.96.254:1337";
  ...
  try {
    ...
    const response = await fetch(`${STRAPI_URL}/api/articles?populate=*`, {
      headers: {
        ...
        Authorization:
          "Bearer ",
      },
    ...
    const processedData = (data as StrapiArticleResponse).data.map(
      (article: Article) => {
